...
#define ITFLIESBY_ENGINE_RENDERER_MEMORY_PARTITION_SIZE             IFB_MATH_MEGABYTES(64)
#define ITFLIESBY_ENGINE_RENDERER_MEMORY_PARTITION_CONTEXT_SIZE     IFB_MATH_MEGABYTES(64)
#define ITFLIESBY_ENGINE_RENDERER_MEMORY_ALLOCATOR_SIZE_SHADER_DATA IFB_MATH_MEGABYTES(4)
