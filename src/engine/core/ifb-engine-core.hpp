...
#define ifb_engine_platform_graphics_api_init ifb_platform_api.graphics_api_init
#define ifb_engine_platform_imgui_init        ifb_platform_api.imgui_init
#define ifb_engine_platform_imgui_frame_start ifb_platform_api.imgui_frame_start
#define ifb_engine_platform_imgui_frame_end   ifb_platform_api.imgui_frame_end
