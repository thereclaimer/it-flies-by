...
#define ITFLIESBY_ENGINE_ASSETS_MEMORY_PARTITION_SIZE         IFB_MATH_MEGABYTES(64)
#define ITFLIESBY_ENGINE_ASSETS_MEMORY_BLOCK_SIZE_INDEX       IFB_MATH_KILOBYTES(1)
#define ITFLIESBY_ENGINE_ASSETS_MEMORY_BLOCK_SIZE_ASSET_DATA  IFB_MATH_MEGABYTES(8)
#define ITFLIESBY_ENGINE_ASSETS_MEMORY_ALLOCATOR_HEADER_SIZE  IFB_MATH_KILOBYTES(1)
#define ITFLIESBY_ENGINE_ASSETS_MEMORY_ALLOCATOR_IMAGE_SIZE   IFB_MATH_MEGABYTES(8)
