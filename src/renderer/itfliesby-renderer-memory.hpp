...
#define ITFLIESBY_RENDERER_MEMORY_PARTITION_UNIFORM_BUFFER_BYTES   ITFLIESBY_MATH_MEGABYTES(2)

#define ITFLIESBY_RENDERER_MEMORY_ALLOCATOR_CORE_SYSTEM_SIZE_BYTES ITFLIESBY_MATH_KILOBYTES(16)
#define ITFLIESBY_RENDERER_MEMORY_ALLOCATOR_UNIFORM_BUFFER_BYTES   ITFLIESBY_MATH_MEGABYTES(1)
